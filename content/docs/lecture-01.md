...
## Lead Poisoning
Our second "parable" this week had to do with lead poisoning. Whe we think of lead poisoning, we often think of [Flint, Michigan](https://en.wikipedia.org/wiki/Flint_water_crisis). Flint's tragedy was the culmination of a [series of political decisions](https://www.theguardian.com/news/2018/jul/03/nothing-to-worry-about-the-water-is-fine-how-flint-michigan-poisoned-its-people). One of the slides in this section showed a [map of homes with high lead levels in their tapwater](https://www.nytimes.com/interactive/2016/02/04/us/flint-water-lead-maps.html) from the New York Times. However, lead poisoning is a naton concern, and we also talked about data collected as part of Reuter's reporting on [lead poisoning](http://www.reuters.com/investigates/special-report/usa-lead-testing/). Their article includes a fascinating (if a bit terrifying) [interactive map](https://www.reuters.com/investigates/graphics/lead-water/en/) of lead poisoning rates. The map includes many, but not all, American states. Two recommended articles on lead poisoning are [Needleman (2003)](https://www.annualreviews.org/doi/full/10.1146/annurev.med.55.091902.103653) and [Sampson and Winter (2016)](https://www.cambridge.org/core/journals/du-bois-review-social-science-research-on-race/article/racial-ecology-of-lead-poisoning/F39AF4724258606DCC1CDA369DC08707).
...
## The Stroke Belt
The "Stroke Belt" refers to a (typically) 7 to 9 state region in America's southeast, where the levels of stroke morbidity and mortality are much higher than the rest of the country. This sits on top of pre-existing disparities in stroke risk for both [race and childhood poverty](https://www.sciencedirect.com/science/article/abs/pii/S1047279708002986). There is still quite a bit we don't know about why stroke rates are higher here (and there are some areas within these states where [rates are lower](https://www.ahajournals.org/doi/full/10.1161/STROKEAHA.116.012997)). However, there appears to be elevated risk for individuals who are [born in these states](https://www.ahajournals.org/doi/full/10.1161/STROKEAHA.107.482059) as well as individuals who [live in them during adulthood](https://n.neurology.org/content/73/22/1858.short). The maps we looked at are based on data from the [Centers for Disease Control (CDC)](https://www.cdc.gov/stroke/maps_data.htm).
...
* Sociologist [C. Wright Mills](https://en.wikipedia.org/wiki/C._Wright_Mills), who wrote the influential text *The Sociological Imagination* (1959)
